                ...
                return t = e, n = [{
                    ...
                    value: function(t, n, i) {
                        var o = e._findMenu(n),
                            ...
                            l = 0;
                        if (t) {
                            var a = e._findParent(r, "menu-sub", !1);
                            if (a) {
                                s = !0;
                                for (var u = a; u;) l++, u = e._findParent(u.parentNode, "menu-sub", !1);
                                n = this._topParent ? this._topParent.parentNode : n
                            }
                            var c = Math.round(this._wrapper.getBoundingClientRect().width),
                                d = this._innerPosition,
                                h = this._getItemOffset(n),
                                m = Math.round(n.getBoundingClientRect().width);
                            h - 5 <= -1 * d ? this._innerPosition = -1 * h : h + d + m + 5 >= c && (this._innerPosition = m > c ? -1 * h : -1 * (h + m - c)), r.classList.add("open");
                            var _ = Math.round(o.getBoundingClientRect().width);
                            if (s) {
                                var v = r.getBoundingClientRect(),
                                    f = this._wrapper.getBoundingClientRect(),
                                    p = _ + (l > 1 ? .5 * _ : 0);
                                v.left - f.left + v.width + p > c && _ < c && (o.style.left = this._rtl ? "100%" : "-105%")
                            } else h + this._innerPosition + _ > c && _ < c && _ > m && (o.style[this._rtl ? "marginRight" : "marginLeft"] = "-".concat(_ - m, "px"));
                            this._closeOther(r, i), this._updateSlider()
                        } else {
                            var g = e._findChild(n, ["menu-toggle"]);
                            if (g.length && g[0].removeAttribute("data-hover", "true"), n.classList.remove("open"), o.style[this._rtl ? "marginRight" : "marginLeft"] = null, o.style.left = null, i)
                                for (var y = o.querySelectorAll(".menu-item.open"), w = 0, L = y.length; w < L; w++) y[w].classList.remove("open")
                        }
                    }
                }, {
                    key: "_slide",
