        ...
        return function() {
            ...
            class P extends S {
                constructor(e) {
                    ...
                    })(["resourceStore", "languageUtils", "pluralResolver", "interpolator", "backendConnector", "i18nFormat", "utils"], e, this), this.options = t, void 0 === this.options.keySeparator && (this.options.keySeparator = "."), this.logger = w.create("translator")
                }
                changeLanguage(e) {
                    e && (this.language = e)
                }
                ...
                extendTranslation(t, o, n, s, i) {
                    ...
                    const a = n.postProcess || this.options.postProcess,
                        l = e(a) ? [a] : a;
                    return null != t && l ? .length && !1 !== n.applyPostProcessor && (t = k.handle(l, t, o, this.options && this.options.postProcessPassResolved ? {
                        i18nResolved: { ...s,
            ...
            class V extends S {
                constructor() {
                    ...
                    var o;
                    if (super(), this.options = U(e), this.services = {}, this.logger = w, this.modules = {
                            external: []
                ...
                init() {
                    ...
                    if (!this.options.isClone) {
                        let e;
                        this.modules.logger ? w.init(r(this.modules.logger), this.options) : w.init(null, this.options), e = this.modules.formatter ? this.modules.formatter : F;
                        const t = new j(this.options);
                        this.store = new O(this.options.resources, this.options);
                        const n = this.services;
                        n.logger = w, n.resourceStore = this.store, n.languageUtils = t, n.pluralResolver = new $(t, {
            ...
            var G = function(e, t) {
                ...
                Y = function(e, t, o, n) {
                    ...
                    "function" == typeof fetch ? fetch(e, t).then(s).catch(o) : Q(e, t).then(s).catch(o)
                },
                Z = !1,
                ee = function(e, t, o, n) {
                    return "function" == typeof o && (n = o, o = void 0), n = n || function() {}, Q && 0 !== t.indexOf("file:") ? function(e, t, o, n) {
                        e.queryStringParams && (t = G(t, e.queryStringParams));
                        var s = B({}, "function" == typeof e.customHeaders ? e.customHeaders() : e.customHeaders);
                    ...
                    }(e, t, o, n) : K() || "function" == typeof ActiveXObject ? function(e, t, o, n) {
                        o && "object" === J(o) && (o = G("", o).slice(1)), e.queryStringParams && (t = G(t, e.queryStringParams));
                        try {
            ...
            const me = () => {
                ...
                try {
                    if (fe = "undefined" != typeof window && null !== window.localStorage, !fe) return !1;
            ...
            const be = () => {
                ...
                try {
                    if (ve = "undefined" != typeof window && null !== window.sessionStorage, !ve) return !1;
                    const e = "i18next.translate.boo";
            ...
            class je {
                ...
                detect() {
                    ...
                    return e.forEach((e => {
                        ...
                        return null != e && !("string" == typeof(t = e) && [/<\s*script.*?>/i, /<\s*\/\s*script\s*>/i, /<\s*img.*?on\w+\s*=/i, /<\s*\w+\s*on\w+\s*=.*?>/i, /javascript\s*:/i, /vbscript\s*:/i, /expression\s*\(/i, /eval\s*\(/i, /alert\s*\(/i, /document\.cookie/i, /document\.write\s*\(/i, /window\.location/i, /innerHTML/i].some((e => e.test(t))));
                        var t
                    })).map((e => this.options.convertDetectedLanguage(e))), this.services && this.services.languageUtils && this.services.languageUtils.getBestMatchFromCodes ? t : t.length > 0 ? t[0] : null
                }
                cacheUserLanguage(e) {
