        ...
        var t = {
                840: function(t, e, n) {
                    ...
                    ! function(r, s, o, a) {
                            ...
                            n.isFirst = !!s, n.isFinal = !!o, s && (t.session = {}), n.eventType = e,
                                function(t, e) {
                                    ...
                                    var s = n.firstInput,
                                        ...
                                        h = e.center = V(i);
                                    e.timeStamp = f(), e.deltaTime = e.timeStamp - s.timeStamp, e.angle = $(u, h), e.distance = B(u, h),
                                        function(t, e) {
                                            var n = e.center,
                                                i = t.offsetDelta || {},
                                                r = t.prevDelta || {},
                                    ...
                                    e.overallVelocityX = c.x, e.overallVelocityY = c.y, e.overallVelocity = p(c.x) > p(c.y) ? c.x : c.y, e.scale = o ? (l = o.pointers, v = i, B(v[0], v[1], k) / B(l[0], l[1], k)) : 1, e.rotation = o ? function(t, e) {
                                        ...
                                        function(t, e) {
                                            ...
                                            if (8 != e.eventType && (u > 25 || o.velocity === a)) {
                                                var h = e.deltaX - o.deltaX,
                                                    c = e.deltaY - o.deltaY,
                                                    l = G(u, h, c);
                                                i = l.x, r = l.y, n = p(l.x) > p(l.y) ? l.x : l.y, s = Z(h, c), t.lastInterval = e
                        ...
                        function st() {
                            this.evEl = it, this.evWin = rt, L.apply(this, arguments), this.store = this.manager.session.pointerEvents = []
                        }
                        r.MSPointerEvent && !r.PointerEvent && (it = "MSPointerDown", rt = "MSPointerMove MSPointerUp MSPointerCancel"), E(st, L, {
                            handler: function(t) {
                                var e = this.store,
                                    n = !1,
                        ...
                        Pt.prototype = {
                            set: function(t) {
                                t == Tt && (t = this.compute()), yt && this.manager.element.style && _t[t] && (this.manager.element.style[gt] = t), this.actions = t.toLowerCase().trim()
                            },
                            update: function() {
                        ...
                        function Ft() {
                            Ct.apply(this, arguments), this.pTime = !1, this.pCenter = !1, this._timer = null, this._input = null, this.count = 0
                        }
                        ...
                        Ct.prototype = {
                            ...
                            emit: function(t) {
                                ...
                                n < 8 && i(e.options.event + Dt(n)), i(e.options.event), t.additionalEvent && i(t.additionalEvent), n >= 8 && i(e.options.event + Dt(n))
                            },
                            tryEmit: function(t) {
                        ...
                        function qt(t, e) {
                            var n;
                            this.options = u({}, Wt.defaults, e || {}), this.options.inputTarget = this.options.inputTarget || t, this.handlers = {}, this.session = {}, this.recognizers = [], this.oldCssProps = {}, this.element = t, this.input = new((n = this).options.inputClass || (X ? st : Y ? lt : N ? ft : tt))(n, H), this.touchAction = new Pt(this, this.options.touchAction), jt(this, !0), m(this.options.recognizers, (function(t) {
                        ...
                        qt.prototype = {
                            ...
                            bindFn: b,
                            prefixed: M
                        }), (void 0 !== r ? r : "undefined" != typeof self ? self : {}).Hammer = Wt, (i = function() {
                            return Wt
