!function (e, r) {
    ...
    return function () {
        ...
        var t, n, i, a = function (e) {
            ...
            return e.reduce((function (e, r) { return e + r }), 0)
            },
            u = function (e, r) {
                return e.slice(0, r)
            }, o = function (e) {
                var r = e.value; return e.delimiters.forEach((function (e) { e.split("").forEach((function (e) { r = r.replace(new RegExp(e.replace(/([.?*+^$[\]\\(){}|-])/g, "\\$1"), "g"), "") })) })), r
            }, c = function (e) {
                var r = e.blocks, t = e.delimiter, n = void 0 === t ? "" : t, i = e.delimiters, a = void 0 === i ? [] : i, l = e.delimiterLazyShow, u = void 0 !== l && l, o = "", c = e.value, s = ""; return r.forEach((function (e, t) { if (c.length > 0) { var i, l = c.slice(0, e), d = c.slice(e); s = a.length > 0 ? null != (i = a[u ? t - 1 : t]) ? i : s : n, u ? (t > 0 && (o += s), o += l) : (o += l, l.length === e && t < r.length - 1 && (o += s)), c = d } })), o
            }, s = function (e) {
        ...
        var m,
            v = ((t = {})[i.UATP] = [4, 5, 6],
                ...
                t[i.MASTERCARD] = [4, 4, 4, 4], t[i.DANKORT] = [4, 4, 4, 4],
                t[i.INSTAPAYMENT] = [4, 4, 4, 4], t[i.JCB15] = [4, 6, 5],
                t[i.JCB] = [4, 4, 4, 4], t[i.MAESTRO] = [4, 4, 4, 4],
                t[i.VISA] = [4, 4, 4, 4], t[i.MIR] = [4, 4, 4, 4],
                t[i.UNIONPAY] = [4, 4, 4, 4],
                t[i.GENERAL] = [4, 4, 4, 4], t),
            f = ((n = {})[i.UATP] = /^(?!1800)1\d{0,14}/,
                n[i.AMEX] = /^3[47]\d{0,13}/, n[i.DISCOVER] = /^(?:6011|65\d{0,2}|64[4-9]\d?)\d{0,12}/,
                ...
                n[i.MIR] = /^220[0-4]\d{0,12}/, n[i.VISA] = /^4\d{0,15}/,
                n[i.UNIONPAY] = /^(62|81)\d{0,14}/, n),
            p = function (e) {
                var r = e.reduce((function (e, r) {
                    return e + r
                }), 0); return e.concat(19 - r)
            },
            h = function (e) {
                for (var r = e.value,
                    t = e.strictMode,
            ...
            g = function (e, r) {
                var t = null != r ? r : {}, n = t.delimiter, i = void 0 === n ? " " : n,
                    s = t.delimiterLazyShow,
                    d = void 0 !== s && s,
                    m = t.strictMode, v = void 0 !== m && m; e = a(e), e = o({ value: e, delimiters: [i] }); var f = h({ value: e, strictMode: v }).blocks, p = l(f); return e = u(e, p), c({ value: e, blocks: f, delimiter: i, delimiterLazyShow: d })
            },
            E = function (e, r) {
                return e = a(e),
