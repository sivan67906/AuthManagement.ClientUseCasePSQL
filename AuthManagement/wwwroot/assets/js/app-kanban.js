...
`, u = (e = "", t = !1, a = "", r = "", n = "") => {
            let d = t ? " pull-up" : "", o = a ? "avatar-" + a : "", i = n ? n.split(",") : []; return e ? e.split(",").map((e, t, a) => {
                a = r && t !== a.length - 1 ? " me-" + r : "", t = i[t] || ""; return `
        ...
        `}).join("") : ""
            ...
            element: ".kanban-wrapper", gutter: "12px", widthBoard: "250px", dragItems: !0, boards: g, dragBoards: !0, addItemButton: !0, buttonContent: "+ Add Item", itemAddOptions: { enabled: !0, content: "+ Add New Item", class: "kanban-title-button btn btn-default border-none", footer: !1 }, click: e => {
                var t = e, a = (t.getAttribute("data-eid") ? t.querySelector(".kanban-text") : t).textContent, r = t.getAttribute("data-due-date"), n = new Date, d = n.getFullYear(), r = r ? r + ", " + d : `${n.getDate()} ${n.toLocaleString("en", { month: "long" })}, ` + d, n = t.getAttribute("data-badge-text"), d = t.getAttribute("data-assigned"); l.show(), o.querySelector("#title").value = a, o.querySelector("#due-date").nextSibling.value = r, $(".kanban-update-item-sidebar").find(i).val(n).trigger("change"), o.querySelector(".assigned").innerHTML = "", o.querySelector(".assigned").insertAdjacentHTML("afterbegin", u(d, !1, "xs", "1", e.getAttribute("data-members")) + `
        <div class="avatar avatar-xs ms-1">
            <span class="avatar-initial rounded-circle bg-label-secondary">
                ...
                let r = document.createElement("form"); r.setAttribute("class", "new-item-form"), r.innerHTML = `
        <div class="mb-4">
