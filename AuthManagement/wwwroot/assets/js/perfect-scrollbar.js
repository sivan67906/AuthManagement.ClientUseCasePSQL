!function (t, e) {
    if ("object" == typeof exports && "object" == typeof module) module.exports = e();
        ...
        var r = e(); for (var i in r) ("object" == typeof exports ? exports : t)[i] = r[i]
    }
}
    (self, (function () {
        return function () {
                ...
                5529: function (t) {
                    t.exports = function () {
                        ...
                        function t(t) {
                            ...
                            for (var r in e) {
                                var i = e[r]; "number" == typeof i && (i += "px"),
                                    t.style[r] = i
                            } return t
                        } function r(t) {
                        ...
                        function o(t, e) {
                            return Array.prototype.filter.call(t.children, (function (t) { return n(t, e) }))
                        }
                        var s = {
                            main: "ps", rtl: "ps__rtl", element: { thumb: function (t) { return "ps__thumb-" + t }, rail: function (t) { return "ps__rail-" + t }, consuming: "ps__child--consume" }, state: { focus: "ps--focus", clicking: "ps--clicking", active: function (t) { return "ps--active-" + t }, scrolling: function (t) { return "ps--scrolling-" + t } }
                        },
                            a = {
                                x: null, y: null
                            };
                        function c(t, e) {
                            var r = t.element.classList, i = s.state.scrolling(e); r.contains(i) ? clearTimeout(a[e]) : r.add(i)
                        }
                        function h(t, e) {
                            a[e] = setTimeout((function () { return t.isAlive && t.element.classList.remove(s.state.scrolling(e)) }), t.settings.scrollingThreshold)
                        }
                        function u(t, e) {
                            c(t, e), h(t, e)
                        }
                        var d = function (t) {
                            ...
                            f = {
                                isEmpty: { configurable: !0 }
                            };
                        d.prototype.bind = function (t, e) {
                            void 0 === this.handlers[t] && (this.handlers[t] = []), this.handlers[t].push(e), this.element.addEventListener(t, e, !1)
                        },
                            d.prototype.unbind = function (t, e) {
                                var r = this; this.handlers[t] = this.handlers[t].filter((function (i) { return !(!e || i === e) || (r.element.removeEventListener(t, i, !1), !1) }))
                            },
                            d.prototype.unbindAll = function () {
                                for (var t in this.handlers) this.unbind(t)
                            },
                            f.isEmpty.get = function () {
                                var t = this; return Object.keys(this.handlers).every((function (e) { return 0 === t.handlers[e].length }))
                            },
                        ...
                        function g(t, e, r, i, n) {
                            var l;
                            if (void 0 === i && (i = !0),
                                void 0 === n && (n = !1), "top" === e) l = ["contentHeight", "containerHeight", "scrollTop", "y", "up", "down"];
                            else {
                        ...
                        function v(t, e, r, i, n) {
                            var l = r[0], o = r[1],
                                s = r[2], a = r[3], c = r[4], h = r[5]; void 0 === i && (i = !0), void 0 === n && (n = !1); var d = t.element; t.reach[a] = null, d[s] < 1 && (t.reach[a] = "start"), d[s] > t[l] - t[o] - 1 && (t.reach[a] = "end"), e && (d.dispatchEvent(b("ps-scroll-" + a)), e < 0 ? d.dispatchEvent(b("ps-scroll-" + c)) : e > 0 && d.dispatchEvent(b("ps-scroll-" + h)), i && u(t, a)), t.reach[a] && (e || n) && d.dispatchEvent(b("ps-" + a + "-reach-" + t.reach[a]))
                        }
                        function m(t) {
                        ...
                        function Y(t) {
                            ...
                            var r = t(e); return m(r.width) + m(r.paddingLeft) + m(r.paddingRight) + m(r.borderLeftWidth) + m(r.borderRightWidth)
                        }
                        p.prototype.eventElement = function (t) {
                            var e = this.eventElements.filter((function (e) {
                                return e.element === t
                            }))[0]; return e || (e = new d(t), this.eventElements.push(e)), e
                        },
                            ...
                            p.prototype.unbindAll = function () {
                                this.eventElements.forEach((function (t) { return t.unbindAll() })), this.eventElements = []
                        ...
                        function M(e) {
                            ...
                            k = function (i, n) {
                                ...
                                for (var o in this.element = i,
                                    ...
                                    this.settings = A(), n) this.settings[o] = n[o]; this.containerWidth = null,
                        ...
                        return k.prototype.update = function () {
                            ...
                            k.prototype.onScroll = function (t) {
                                ...
                                this.element.className = this.element.className.split(" ").filter((function (t) { return !t.match(/^ps([-_].+|)$/) })).join(" ")
                            }, k
                    }()
                }
            }, e = {};
            function r(i) {
                ...
                var l = e[i] = { exports: {} }; return t[i].call(l.exports, l, l.exports, r), l.exports
